  ...
  data() {
    return {
      ...
      /*
        INTEGERS
      */
      { problem: '\\frac{72}{-9}', js: -8, cat: 'ints' }, { problem: '\\frac{-9}{3}', js: -3, cat: 'ints' }, { problem: '-65+76*54-87', js: -65 + 76 * 54 - 87, cat: 'ints' }, { problem: '-57-49', js: -106, cat: 'ints' }, { problem: '25*-12^2', js: -3600, cat: 'ints' }, { problem: '36/2+36', js: 36 / 2 + 36, cat: 'ints' }, { problem: '54(-6)-41', js: 54 * -6 - 41, cat: 'ints' }, { problem: '-54(85-76)+-63', js: -54 * (85 - 76) + -63, cat: 'ints' }, { problem: '64(2)+(-12)', js: 64 * 2 + -12, cat: 'ints' }, { problem: '(212-32)*\\frac{5}{9}', js: (212 - 32) * (5 / 9), cat: 'ints' }, //Fahrenheit to Celsius
      { problem: '(68-32)*(\\frac{5}{9})', js: (68 - 32) * (5 / 9), cat: 'ints' }, //Fahrenheit to Celsius

      /*
        ABSOLUTE VALUE
      */
      { problem: '|7|', js: 7, cat: 'abs' }, { problem: '-|-34|+45', js: -Math.abs(-34) + 45, cat: 'abs' }, { problem: '-|-5|+6', js: -5 + 6, cat: 'abs' }, { problem: '|-34|', js: Math.abs(-34), cat: 'abs' }, { problem: '|65|', js: Math.abs(65), cat: 'abs' }, { problem: '|54|', js: Math.abs(54), cat: 'abs' }, { problem: '|-56|', js: Math.abs(-56), cat: 'abs' },
      /*
        ORDER OF OPERATIONS
      */
      { problem: '95(73+54)-63+9^5', js: 95 * (73 + 54) - 63 + 9 ^ 5, cat: 'ooo' }, { problem: '93(-5+7)-73+34', js: 93 * (-5 + 7) - 73 + 34, cat: 'ooo' }, { problem: '(57*(32-21)-5)', js: 622, cat: 'ooo' }, { problem: '-5*56*(-8-9)', js: 4760, cat: 'ooo' }, { problem: '12+5-(-26)+(-2)', js: 12 + 5 - -26 + -2, cat: 'ooo' }, { problem: '18(45+53)-32+24-9^8', js: 18 * (45 + 53) - 32 + 24 - 9 ^ 8, cat: 'ooo' }]
    };
  }, created() {
